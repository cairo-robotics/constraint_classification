...
namespace predicate_classifiers{
	float ProximityClassifier::getEuclideanDistance(float x1, float y1, float z1, float x2, float y2, float z2)
	{
		float delta_x = x1 - x2;
		float delta_y = y1 - y2;
		float delta_z = z1 - z2;
	...
	bool ProximityClassifier::classify(geometry_msgs::Pose object_one_pose, geometry_msgs::Pose object_two_pose, float threshold_distance)
	{
	...
	bool UprightClassifier::classify(geometry_msgs::Pose upright_pose, geometry_msgs::Pose current_pose, float threshold_angle)
	{
	...
	bool HeightClassifier::classify(geometry_msgs::Pose object_pose, float reference_height, float threshold_distance)
	{
